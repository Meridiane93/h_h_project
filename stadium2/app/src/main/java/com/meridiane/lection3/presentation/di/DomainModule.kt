...
import com.meridiane.lection3.domain.useCaseAuthorization.ClearCoordinate
import com.meridiane.lection3.domain.useCaseAuthorization.ClearCoordinateUseCaseImpl
...
import com.meridiane.lection3.domain.useCaseAuthorization.GetCoordinateUseCaseImpl
...
import com.meridiane.lection3.domain.useCaseAuthorization.SaveCoordinateUseCaseImpl
...
class DomainModule {
    ...
    @Provides
    fun orderTab(mockRepository: MockRepository): GetOrderInterface =
        GetProductsUseCaseImpl(getAllOrderInterface = mockRepository)

    @Provides
    fun saveCoordinate(mockRepository: MockRepository): SaveCoordinate =
        SaveCoordinateUseCaseImpl(interfaceSaveCoordinate = mockRepository)

    @Provides
    fun getCoordinate(mockRepository: MockRepository): GetCoordinate =
        GetCoordinateUseCaseImpl(interfaceGetCoordinate = mockRepository)

    @Provides
    fun clearCoordinate(mockRepository: MockRepository): ClearCoordinate =
        ClearCoordinateUseCaseImpl(interfaceClearCoordinate = mockRepository)
}